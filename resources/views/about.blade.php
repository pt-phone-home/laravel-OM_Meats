...
<div class="div bgi-g1 pt-8 flex"> 
    ...
    <h1 class="text-grey-lightest bgi-p py-6 w-1/3 text-center rounded-t-xlg font-nun font-light uppercase">
        In the beginning
    </h1>
    <div class="w-1/3">
...
<div class="div bgi-s pt-8 flex"> 
    ...
    <h1 class="text-p bgi-g2 py-6 w-1/3 text-center rounded-t-xlg font-nun font-light uppercase">
