    ...
    <div class="container mx-auto py-12 flex justify-center">
        ...
        <div class="">
            ...
            <div class="px-8 text-grey-darkest">
                ...
                <p class="py-2 text-lg"><i class="fas fa-ellipsis-h text-p mr-4"></i>Shop: 01 8476000 +4</p>
                <p class="py-2 text-lg"><i class="fas fa-ellipsis-h text-p mr-4"></i>Sales: 01 8476000 +5 / michael@ommeats.ie</p>
            </div>
        </div>
