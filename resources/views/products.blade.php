    ...
    <div class="container mx-auto flex flex-wrap justify-center py-12">
                ...
                <div class="px-1 py-1 bgi-g1 rounded-b -mt-1 border-b-2 border-p text-sm hidden" id="prodInfo1">
                    <div class="flex justify-between w-full">
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            {{-- border-b border-p border-dashed --}}
                            <p class="py-1 pb-2">Beef Brisket</p>
                            <p class="py-1 pb-2">Beef Burgers 4oz-10oz</p>
                            <p class="py-1 pb-2">Beef Cheeks</p>
                            <p class="py-1 pb-2">Beef Fillets (whole)</p>
                            <p class="py-1 pb-2">Beef Meatballs 1oz-4oz</p>
                            <p class="py-1 pb-2">Beef Mince 95VL</p>
                            <p class="py-1 pb-2">Beef Strogonoff</p>
                            <p class="py-1 pb-2">Beef Topside</p>
                            <p class="py-1 pb-2">Bones </p>
                            <p class="py-1 pb-2">Cube Roll </p>
                            <p class="py-1 pb-2">Diced Beef</p>
                            <p class="py-1 pb-2">Eye of the Round</p>
                            <p class="py-1 pb-2">Oxtails</p>
                        </div>
                        <div class="flex flex-col px-4">
                            <hr class="border border-p h-full">
                        </div>
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Picanha</p>
                            <p class="py-1 pb-2">Rib of Beef</p>
                            <p class="py-1 pb-2">Rump Roast Beef</p>
                            <p class="py-1 pb-2">Silverside Corned Beef</p>
                            <p class="py-1 pb-2">Fillet Steaks</p>
                            <p class="py-1 pb-2">Rib Eye Steaks</p>
                            <p class="py-1 pb-2">Sirloin Steaks</p>
                            <p class="py-1 pb-2">Striploin Steaks</p>
                            <p class="py-1 pb-2">Striploins (whole)</p>
                            <p class="py-1 pb-2">Top Rib</p>
                            <p class="py-1 pb-2">Bone-in Rib Eye</p>
                            <p class="py-1 pb-2">T-bone Steaks</p>
                            <p class="py-1 pb-2">Tomahawk Steaks</p>
                ...
                <div class="px-1 py-1 bgi-g1 rounded-b -mt-1 border-b-2 border-p text-sm hidden" id="prodInfo2">
                    <div class="flex justify-between w-full">
                        <div class="w-45p flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Baby Back Loin Ribs</p>
                            <p class="py-1 pb-2">Back Rashers - plain, smoked, maple</p>
                            <p class="py-1 pb-2">Bacon - diced, lardons, minced</p>
                            <p class="py-1 pb-2">Bacon Chops</p>
                            <p class="py-1 pb-2">Breakfast Packs</p>
                            <p class="py-1 pb-2">Collar of Bacon Joints</p>
                            <p class="py-1 pb-2">Diced Pork</p>
                            <p class="py-1 pb-2">Gammon Fillets</p>
                            <p class="py-1 pb-2">Ham Hocks</p>
                            <p class="py-1 pb-2">Legs of Pork</p>
                            <p class="py-1 pb-2">Loins of Pork</p>
                            <p class="py-1 pb-2">Minced Pork</p>
                            <p class="py-1 pb-2">Pigs in Blankets</p>
                        </div>
                        <div class="flex flex-col px-4">
                            <hr class="border border-p h-full">
                        </div>
                        <div class="w-45p flex-1 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Pork Belly</p>
                            <p class="py-1 pb-2">Pork Bones</p>
                            <p class="py-1 pb-2">Pork Cheeks</p>
                            <p class="py-1 pb-2">Pork Chops</p>
                            <p class="py-1 pb-2">Pork Escalopes - plain, breaded</p>
                            <p class="py-1 pb-2">Pork Neck Fillets</p>
                            <p class="py-1 pb-2">Pork Belly Ribs</p>
                            <p class="py-1 pb-2">Pork Shanks</p>
                            <p class="py-1 pb-2">Pork Shoulders</p>
                            <p class="py-1 pb-2">Pork Steaks</p>
                            <p class="py-1 pb-2">Pudding B &amp; W <span class="italic">(including Clonakilty)</span></p>
                            <p class="py-1 pb-2">Sausages (various sizes &amp; flavours)</p>
                            <p class="py-1 pb-2">Streaky Rashers</p>
                            <p class="py-1 pb-2 italic">... and many more</p>
                        </div>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-2 py-4">
            <div class="flex flex-col">
                ...
                <div class="h-10r">
                     <img src="/images/eggs.png" alt="" class="w-full h-full object-cover">
                </div>
                <div class="flex justify-center  bgi-p py-2 rounded-b-lg group">
                ...
                <div class="px-1 py-1 bgi-g1 rounded-b -mt-1 border-b-2 border-p text-sm hidden" id="prodInfo3">
                    <div class="flex justify-between w-full">
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2 text-center font-bold">Chicken</p>
                            <p class="py-1 pb-2">Chicken Burgers</p>
                            <p class="py-1 pb-2">Chicken Crowns</p>
                            <p class="py-1 pb-2">Chicken Fillets</p>
                            <p class="py-1 pb-2">Chicken Fillets Breaded</p>
                            <p class="py-1 pb-2">Chicken Fillets Butterflied</p>
                            <p class="py-1 pb-2">Chicken Kiev</p>
                            <p class="py-1 pb-2">Chicken Legs</p>
                            <p class="py-1 pb-2">Chicken Liver</p>
                            <p class="py-1 pb-2">Chicken Sausages</p>
                            <p class="py-1 pb-2">Chicken Skewers</p>
                            <p class="py-1 pb-2">Chicken Stroganoff</p>
                            <p class="py-1 pb-2">Chicken Supremes</p>
                            <p class="py-1 pb-2">Chicken Thigh Meat</p>
                            <p class="py-1 pb-2">Chicken Wings</p>
                            <p class="py-1 pb-2">Chickens (whole) 900g-1900g</p>
                            <p class="py-1 pb-2">Diced Chicken - breast, legs, mixed</p>
                        ...
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2 text-center font-bold">Poultry &amp; Eggs</p>
                            <p class="py-1 pb-2">Hen and Duck Eggs</p>
                            <p class="py-1 pb-2">Farm and Free Range</p>
                            <p class="py-1 pb-2">Turkey - Diced</p>
                            <p class="py-1 pb-2">Turkey - Whole Fresh</p>
                            <p class="py-1 pb-2">Turkey Breast - Mince</p>
                            <p class="py-1 pb-2">Turkey Burgers</p>
                            <p class="py-1 pb-2">Turkey Butterfly</p>
                            <p class="py-1 pb-2">Turkey Escalopes - plain, breaded</p>
                            <p class="py-1 pb-2">Turkey Fillets B/R</p>
                            <p class="py-1 pb-2">Turkey Legs</p>
                            <p class="py-1 pb-2">Turkey Meatballs</p>
                            <p class="py-1 pb-2">Turkey Sausages</p>
                            <p class="py-1 pb-2">Turkey Stroganoff</p>
                            <p class="py-1 pb-2">Duck Breasts (230g-280g)</p>
                            <p class="py-1 pb-2">Duck Liver</p>
                            <p class="py-1 pb-2">Duck Legs</p>
                            <p class="py-1 pb-2 italic">... and many more</p>
                        </div>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-2 py-4">
            <div class="flex flex-col">
                ...
                <div class="px-1 py-1 bgi-g1 rounded-b -mt-1 border-b-2 border-p text-sm hidden" id="prodInfo4">
                    <div class="flex justify-between w-full">
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Diced Lamb</p>
                            <p class="py-1 pb-2">Gigot Lamb Chops</p>
                            <p class="py-1 pb-2">Halal Lamb</p>
                            <p class="py-1 pb-2">Lamb Chops</p>
                            <p class="py-1 pb-2">Lamb Fillets</p>
                            <p class="py-1 pb-2">Lamb Heart, Kidney &amp; Liver</p>
                            <p class="py-1 pb-2">Lamb Meatballs</p>
                            <p class="py-1 pb-2">Lamb Neck Fillets</p>
                        </div>
                        <div class="flex flex-col px-4">
                            <hr class="border border-p h-full">
                        </div>
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Lamb Shanks</p>
                            <p class="py-1 pb-2">Lamb Stroganoff</p>
                            <p class="py-1 pb-2">Legs of Lamb</p>
                            <p class="py-1 pb-2">Minced Lamb</p>
                            <p class="py-1 pb-2">Racks of Lamb</p>
                            <p class="py-1 pb-2">Shoulders of Lamb B&amp;R</p>
                            <p class="py-1 pb-2">Spring Lambs (Whole)</p>
                            <p class="py-1 pb-2">Sweetbreads</p>
                            <p class="py-1 pb-2 italic">... and many more</p>
                        </div>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 px-2 py-4">
            <div class="flex flex-col">
                ...
                <div class="px-1 py-1 bgi-g1 rounded-b -mt-1 border-b-2 border-p text-sm hidden" id="prodInfo5">
                    <div class="flex justify-between w-full">
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Beef Lasagne</p>
                            <p class="py-1 pb-2">Beef Shepherd’s Pie </p>
                            <p class="py-1 pb-2">Chicken Bites</p>
                            <p class="py-1 pb-2">Chicken Goujons</p>
                        ...
                        <div class="w-1/2 flex flex-col justify-around px-2">
                            <p class="py-1 pb-2">Cooked Gammon</p>
                            <p class="py-1 pb-2">Cooked Ham - Sliced </p>
                            <p class="py-1 pb-2">Cooked Turkey Fillets</p>
                            <p class="py-1 pb-2">Corned Beef Joint</p>
                            <p class="py-1 pb-2">Roast Beef - Sliced</p>
                            <p class="py-1 pb-2">Ham &amp; Turkey Portions</p>
                            <p class="py-1 pb-2">Southern Fried Chicken</p>
                            <p class="py-1 pb-2 italic">... and many more</p>
                        </div>
                    </div>
                </div>
